...

{
  ...
  await generator.trace('node:process');

  const json = generator.getMap();

  assert.strictEqual(json.imports['node:process'], `https://ga.jspm.io/npm:@jspm/core@2.0.0-beta.20/nodelibs/browser/process-production.js`);
}
