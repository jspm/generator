...

{
  ...
  assert.strictEqual(json.imports.lit, 'https://ga.jspm.io/npm:lit@2.6.1/index.js');
  assert.strictEqual(json.imports['lit/directive.js'], 'https://ga.jspm.io/npm:lit@2.6.1/directive.js');
}
