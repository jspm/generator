...
assert.strictEqual(await generator.htmlInject(html, { pins, whitespace: true }), 
  "\n" +
    "  <!doctype html>\n" +
...
assert.strictEqual(await generator.htmlInject(html, { pins, whitespace: false }),
  "\n" +
    "  <!doctype html>\n" +
    "  <!-- Generated by @jspm/generator - https://github.com/jspm/generator -->\n" +
    `  <script async src="${esmsUrl}" crossorigin="anonymous"></script>\n` +
...
assert.strictEqual(await generator.htmlInject(html, { pins }),
  `
<!DOCTYPE html>
<html lang="en">
<head>
